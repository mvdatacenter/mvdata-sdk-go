...
//
// Currently duplicated from github.com/mvdatacenter/mvdata-sdk-go/config because
// service packages cannot import github.com/mvdatacenter/mvdata-sdk-go/config
