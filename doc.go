// Package sdk is the official MVData SDK for the Go programming language.
//
// mvdata-sdk-go is the the MVData SDK for the Go programming language.
//
// # Getting started
//
...
//
//	go get github.com/mvdatacenter/mvdata-sdk-go
