module github.com/mvdatacenter/mvdata-sdk-go/config

go 1.20

require (
	github.com/mvdatacenter/mvdata-sdk-go v1.30.0
	github.com/mvdatacenter/mvdata-sdk-go/credentials v1.17.21
	github.com/mvdatacenter/mvdata-sdk-go/feature/ec2/imds v1.16.8
	github.com/mvdatacenter/mvdata-sdk-go/internal/ini v1.8.0
