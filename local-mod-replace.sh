...
go mod graph | awk '{print $1}' | cut -d '@' -f 1 | sort | uniq | grep "github.com/mvdatacenter/mvdata-sdk-go" | while read x; do
  repPath=${x/github.com\/aws\/mvdata-sdk-go/${SDK_SOURCE_DIR}}
